...
\ensuremath{(\tilde{d} > 0)} & -0.039\sym{*} & -0.034 & -0.035\sym{*} \\
 & (0.019) & (0.019) & (0.019) \\
\ensuremath{(\tilde{d} \geq \tilde{d}_{0.5})} &  & -0.009 & -0.022 \\
 &  & (0.014) & (0.016) \\
\ensuremath{(\tilde{d} \geq \tilde{d}_{0.75})} &  &  & 0.021 \\
 &  &  & (0.022) \\
...
After \ensuremath{\times (\tilde{d} > 0)} & -0.007 & -0.006 & -0.006 \\
 & (0.008) & (0.012) & (0.012) \\
1933 \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.5})} &  & -0.022 & -0.007 \\
 &  & (0.018) & (0.032) \\
1934 \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.5})} &  & -0.007 & 0.018 \\
 &  & (0.014) & (0.025) \\
After \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.5})} &  & -0.002 & 0.003 \\
 &  & (0.009) & (0.018) \\
1933 \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.75})} &  &  & -0.030 \\
 &  &  & (0.037) \\
1934 \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.75})} &  &  & -0.055 \\
 &  &  & (0.036) \\
After \ensuremath{\times (\tilde{d} \geq \tilde{d}_{0.75})} &  &  & -0.004 \\
 &  &  & (0.033) \\
\midrule
