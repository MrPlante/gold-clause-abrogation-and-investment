...
\label{tab:sum_main}
  \input{tables/tab_summary_panels.tex}
...
\label{tab:sum_diff}  \input{tables/tab_bonds_1930_1935}
...
\label{tabapp:bonds}
  \input{tables/tab_d_groups_dorig}
...
\begin{table}[p]\centering
\caption{\\ Average characteristics for $d = 0$ and $d > 0$ firms}\scriptsize
\label{tab:pretrend}  \input{tables/tab_changes_1926_1930}
...
\input{tables/tab_reghdfe_others}
...
\input{tables/tab_reghdfe_Q_d_low}
