...
\end{tabular}
\\[4pt]
\begin{minipage}{0.92\textwidth}\footnotesize \textit{Note.} Same construction as the previous table; each window is three trading days from the event date, following Table~IA.20.\end{minipage}
}
\end{center}
