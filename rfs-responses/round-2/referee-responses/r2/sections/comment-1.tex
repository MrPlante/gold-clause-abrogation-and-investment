...
\noindent Thank you for this suggestion; it changed the paper. We did what the referee asked: we built the four return series he lists from CRSP daily returns and examined the market's response to every legal development of the litigation, from the Joint Resolution through the first lawsuits, the lower court rulings, the certiorari grants, the oral arguments, and the decision. Two findings came out of that examination. First, none of the intermediate judicial steps produced a significant differential between exposed and non-exposed firms, consistent with procedural steps that confirmed the status quo being largely anticipated. Second, the examination surfaced an event the previous draft had missed: over November~5--8, 1934, when the certiorari grant in \textit{United States v.\ Bankers Trust Co.} coincided with the midterm election, exposed firms outperformed by $+3.5$ percentage points ($t = 3.3$), the second-largest differential of the episode after the Joint Resolution. We owe this finding to the referee's suggestion. The event is now part of the main analysis (Table~1, Section~3, and Internet Appendix Figure~IA.3), and we return to it below.
