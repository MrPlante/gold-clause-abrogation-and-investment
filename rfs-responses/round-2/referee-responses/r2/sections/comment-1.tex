...
\noindent Because the events last only a few days each over a nearly two-year period, plotting them all in one graph makes it impossible to visualize the effects. Instead, we plotted individual graphs of the four return series around each event; Internet Appendix Figures~IA.2--IA.5 report them; for convenience, we also reproduce them below.
