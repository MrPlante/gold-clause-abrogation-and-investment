"""Validation tests for Internet Appendix Table 3 (tilde-d = 0 summary stats)."""
...
from tables.appendix.ia_3_summary_I_0 import (  # noqa: E402
    TOL,
    VARIABLES_BY_PANEL,
    load_panel,
...
def test_ia_3_summary_I_0_matches_manuscript():
