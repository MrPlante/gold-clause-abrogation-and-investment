\begin{table}[p]\centering
    ...
    \midrule
    Total net investment in \%               & -5.50 & -2.47 & -0.21 \\
    Gold clause effect in \%               & -1.77 & -1.29 & -0.21 \\
    \midrule
    \multicolumn{4}{c}{\textit{Panel B: $\tilde{d}>0$ firms}}\\
    \midrule
    Total net investment in \%               & -6.67 & -3.03 & -0.88 \\
    Gold clause effect in \%               & -3.26 & -2.31 & -0.40 \\
    \midrule
    \multicolumn{4}{c}{\textit{Panel C: $\tilde{d}=0$ firms}}\\
    \midrule
    Total net investment in \%               & -4.13 & -1.77 & 0.68 \\
    \bottomrule
