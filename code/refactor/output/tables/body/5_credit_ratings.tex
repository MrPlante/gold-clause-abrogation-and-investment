\begin{table}[p]
    ...
    \renewcommand{\arraystretch}{1.2}{
        ...
        \midrule
        \ensuremath{\text{1933} \times \tilde{d}} & -0.036\sym{***} & 0.017 \\
         & (0.013) & (0.011) \\
        \ensuremath{\text{1934} \times \tilde{d}} & -0.047\sym{***} & 0.025\sym{***} \\
         & (0.008) & (0.008) \\
        \ensuremath{\text{1933} \times \text{Low rating}} & -0.038\sym{**} & 0.012\sym{**} \\
         & (0.016) & (0.005) \\
        \ensuremath{\text{1934} \times \text{Low rating}} & 0.029\sym{***} & 0.009 \\
         & (0.003) & (0.007) \\
        \ensuremath{\text{1933} \times \tilde{d} \times \text{Low rating}} & -0.073 & -0.016 \\
         & (0.046) & (0.017) \\
        \ensuremath{\text{1934} \times \tilde{d} \times \text{Low rating}} & -0.077\sym{***} & -0.026\sym{**} \\
         & (0.024) & (0.010) \\
        \midrule
        Firm FE & \multicolumn{1}{c}{Yes} & \multicolumn{1}{c}{Yes} \\
        Year FE & \multicolumn{1}{c}{Yes} & \multicolumn{1}{c}{Yes} \\
        \ensuremath{R^2} & 0.244 & 0.792 \\
