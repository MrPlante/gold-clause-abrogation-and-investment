The goal of the file @code/quarterly-div.py is to do a higher frequency analysis of the dividend response around the significant events related to the abrogation of the gold clause.
