...
|---|---|---|
| Table 1 | `table1_event_study.tex` | Event study (generated by `analysis/eventstudy/pipeline.py`) |
| Table 2 | `table2_summary_stats.tex` | Summary statistics |
| Table 3 | `table3_bond_stats.tex` | Bond statistics |
| Table 4 | `table4_investment.tex` | Main investment panel (baseline; old Table 1) |
| Table 5 | `table5_other_outcomes.tex` | Other outcomes |
| Table 6 | `table6_credit_ratings.tex` | Credit ratings |
| Table 7 | `table7_controls.tex` | Controls robustness (old Table 6) |
| Table 8 | `table8_aggregate.tex` | Aggregated investment effects |
...
|---|---|---|
| IA.17 | `ia17_stock_controls.tex` | Stock market controls |
| IA.18 | `ia18_aggregate_heterogeneous.tex` | Heterogeneous effects |
| IA.19 | `ia19_controls_indyear.tex` | Cols 2-10 of Table 7 with industry×year FEs |
