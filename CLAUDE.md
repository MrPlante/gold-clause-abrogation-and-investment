...
This regenerates all body and IA tables into `code/output/` and also
...
stata-mp -b do code/stata/A12_controls_indyear.do
```
...
Built/rebuilt by `code/sql/build_gold_claude_crsp.sql` (run
...
|---|---|---|
| Table 1 | `0_event_study.tex` | Event study (generated by `code/event_study_pipeline.py`) |
...
- Regressions that require exact Stata SEs use `code/stata/` do-files
