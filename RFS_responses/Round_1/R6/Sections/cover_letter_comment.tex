...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../Responses Figures/R6_gold_stock.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../Responses Figures/R6_discount_rate.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../Responses Figures/R6_bond_quotes.png}
