...
TABLE4_NOTES = (
    ...
    r"equity payout, Dividend is cash dividends, and Net rep.\ is net share repurchases. These "
    r"outcomes use a fixed, firm-specific denominator equal to average book common stock over "
    r"all available observations through 1930. If 1930 is unavailable, the averaging window "
    r"extends through the firm's first subsequent observation; for firms observed only before "
    r"1930, it includes all available observations. Columns 4--6 examine whether gold exposure "
    ...
    r"securities; Profits and Cash use a fixed, firm-specific denominator equal to average fixed "
    r"capital over the same base-period observations, while Leverage is book leverage. All "
