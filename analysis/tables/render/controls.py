...
TABLE6_NOTES = (
    ...
    r"1930, or the first available year thereafter) interacted with the four period indicators "
    r"as linear controls. Columns 3--10 use a non-parametric approach: each column includes "
    r"decile dummies for a single base-period characteristic interacted with the four period "
    r"indicators. The characteristics are: (3) $Q$, "
