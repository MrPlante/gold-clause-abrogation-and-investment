...
TABLE5_NOTES = (
    ...
    r"interactions, year $\times$ low-rating interactions, and triple interactions among year, "
    r"$\tilde{d}$, and a low credit rating indicator. Low rating "
    r"equals one if a firm's bond rating is Ba or below in 1930 (the median rating among bond "
    r"issuers). To ease interpretation, $\tilde{d}$ is centered by subtracting its sample mean "
    r"among positive-exposure firm-years. All regressions include firm and year fixed "
