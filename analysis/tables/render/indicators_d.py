...
TABLE14_NOTES = (
    ...
    r"single indicator $(\tilde{d} > 0)$. Column 2 adds an indicator for at-or-above-median exposure "
    r"$(\tilde{d} \geq \tilde{d}_{0.50})$. Column 3 further adds an indicator for at-or-above "
    r"the 75th percentile $(\tilde{d} \geq \tilde{d}_{0.75})$, where $\tilde{d}_{0.50}$ and "
    r"$\tilde{d}_{0.75}$ are the "
