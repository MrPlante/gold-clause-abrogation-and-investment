...
TABLE15_NOTES = (
    ...
    r"2 of Table \ref{tab:controls} as well as period interactions with daily-return average "
    r"and volatility and the three Fama--French betas. Columns 2--6 use a non-parametric "
    r"approach: each column includes decile dummies for, respectively, return average, return "
    r"volatility, market beta, SMB beta, or HML beta, measured in 1930 (or the first available "
    r"year thereafter), interacted with the four period indicators. All regressions "
    r"include firm and year fixed effects. Accounting variables "
