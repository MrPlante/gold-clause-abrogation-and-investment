...
TABLE13_NOTES = (
    ...
    r"column 6 uses dividends divided by lagged book equity; column 7 uses dividends divided "
    r"by market capitalization in 1930; column 8 uses dividends as a share of net income for "
    r"firms with positive net income exceeding the dividend. All "
