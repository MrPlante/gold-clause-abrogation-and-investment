...
TABLE13_NOTES = (
    ...
    r"omitted category. Columns 1--4 use cash dividends normalized by the average book value of "
    r"common stock until 1930 as the dependent variable: column 1 (2) includes firm-year "
    r"observations where a firm paid a positive (zero) amount of cash dividends in the previous "
    r"year; column 3 (4) includes firms that paid a positive (zero) amount of cash dividends in "
    r"1932. Columns 5--8 use the full sample with alternative dependent variable definitions: "
    r"column 5 uses annual dividend growth (set to zero if dividends are zero in both years); "
    r"column 6 uses total equity payout divided by lagged book equity; column 7 uses total "
    r"equity payout divided by market capitalization in 1930; column 8 uses total equity payout "
    r"as a share of net income for firms with positive net income exceeding the dividend. All "
    r"regressions include firm and year fixed effects. All variables are winsorized at the "
    r"0.5\% and 99.5\% levels within each year. Standard errors in "
