...
CONSTRAINTS_NOTES = (
    ...
    r"interactions with a firm characteristic measure $I$, where the pre-abrogation period "
    r"(1926--1932) is the omitted category. The cutoffs are the medians among positive-exposure "
    r"firms in 1930 (or their first available year thereafter). In column 1, $I$ is the firm's "
    r"share of observed years with assets below the cutoff; in column 2 it is the share of years "
    r"with cash/assets below the cutoff; and in column 3 it is the share of years with book "
    r"leverage above the cutoff. Thus, $I$ ranges from zero to one rather than being a binary "
    r"1930 split. All regressions include firm and year fixed effects. All variables are "
