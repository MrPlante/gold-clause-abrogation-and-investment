...
CONSTRAINTS_NOTES = (
    ...
    r"below-median asset size among $\tilde{d} > 0$ firms in 1930. In column 2, $I$ equals one "
    r"if a firm has below-median cash/assets among $\tilde{d} > 0$ firms in 1930. In column 3, "
    r"$I$ equals one if a firm has above-median book leverage among $\tilde{d} > 0$ firms in "
    r"1930. All regressions include firm and year fixed effects. All variables are "
