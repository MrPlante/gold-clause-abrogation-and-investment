...
from config import MANUSCRIPT_APPENDIX_TABLES
...
TABLE_NOTES = (
    ...
    r"column (1) includes all base-period firm characteristics interacted with the four period "
    r"indicators as linear controls; columns (2)--(9) each include decile dummies for a single "
    r"base-period characteristic interacted with the four period indicators. Base-period "
    r"characteristics are measured in 1930, or the first available year thereafter. All "
    r"regressions include firm and SIC2 industry-year fixed "
