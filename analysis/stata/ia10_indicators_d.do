...
* Input:  data/processed/stata_inputs/ia10_indicators_d.dta
*         (written by analysis/tables/appendix/ia10_indicators_d.py per
*         A19_indicators.do: dind/dind2/dind3 cutoffs and period interactions)
* Output: analysis/stata/results/ia10_indicators_d_results.csv
* Run:    stata-mp -b do analysis/stata/ia10_indicators_d.do [project_root]
version 16
set more off
args root
if "`root'" == "" local root .

use "`root'/data/processed/stata_inputs/ia10_indicators_d.dta", clear
...
file open fh using "`root'/analysis/stata/results/ia10_indicators_d_results.csv", write replace
