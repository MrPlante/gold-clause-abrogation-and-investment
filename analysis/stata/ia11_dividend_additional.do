...
* Input:  data/processed/stata_inputs/ia11_dividend_additional.dta
*         (written by analysis/tables/appendix/ia11_dividend_additional.py:
...
* Output: analysis/stata/results/ia11_dividend_additional_results.csv
* Run:    stata-mp -b do analysis/stata/ia11_dividend_additional.do [project_root]
version 16
set more off
args root
if "`root'" == "" local root .

use "`root'/data/processed/stata_inputs/ia11_dividend_additional.dta", clear
...
file open fh using "`root'/analysis/stata/results/ia11_dividend_additional_results.csv", write replace
