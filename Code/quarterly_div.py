...
plt.tight_layout()
fig.savefig(f"{OUTPUT_DIR}/quarterly_div_coefficients.pdf", bbox_inches="tight", dpi=300)
fig.savefig(f"{OUTPUT_DIR}/quarterly_div_coefficients.png", bbox_inches="tight", dpi=300)
print(f"\nFigure saved to {OUTPUT_DIR}/quarterly_div_coefficients.{{pdf,png}}")
...
regtable_path = f"{OUTPUT_DIR}/quarterly_div_regtable.tex"
regtable_appendix = "Manuscript/Tables/Online_appendix/11_quarterly_div.tex"
